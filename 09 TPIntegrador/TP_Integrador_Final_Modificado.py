...
def agregar_pais(paises):   #Agregar un nuevo pais
...
def actualizar_datos(paises):  #Actualizar poblacion y superficie de un pais
...
def buscar_pais(paises):  #Buscar pais por nombre
...
def filtrar_paises(paises):  #Filtar Paises por Continente,rango de poblacion o rengo de superficie
    ...
    if opcion_filtro=='A':
        ...
        sup_min=obtener_input("Superficie Mínima:",tipo=int,puede_ser_vacio=True)
