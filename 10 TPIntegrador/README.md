...
* **El ordenamiento** se realiza mediante la **comparación y permutación directa** de elementos.
* **La búsqueda de extremos**(`max`/`min` en estadísticas) se realiza mediante **bucles de inicialización e iteración simple++
